...
class GenomicInterval(object):
    ...
    def __ne__(self, other):
        return (self.contig != other.contig or self.start != other.start
                or self.end != other.end)

    def __lt__(self, other):
        return (self.contig < other.contig
                or (self.contig == other.contig and
                    (self.start < other.start
                     or self.start == other.start and self.end < other.end)))

    def __le__(self, other):
        return (self.contig < other.contig
                or (self.contig == other.contig and self.end <= other.end))
